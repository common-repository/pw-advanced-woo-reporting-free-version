    ...
    <?php
		...
		foreach($our_menu as $roots){
			foreach($roots['childs'] as $childs){
				...
				{
					$basic_menu.='<a class="menu__link" href="#" id="'.$childs['id'].'"><i class="fa '.$childs['icon'].'"></i>'.$childs['label'].'</a>';
				}else if($roots['parent']=='more_reports')
				{
					$more_reports.='<a class="menu__link" href="#" id="'.$childs['id'].'"><i class="fa '.$childs['icon'].'"></i>'.$childs['label'].'</a>';
				}else if($roots['parent']=='cross_tab')
				{
					$cross_menu.='<a class="menu__link" href="#" id="'.$childs['id'].'"><i class="fa '.$childs['icon'].'"></i>'.$childs['label'].'</a>';
				}else if(!isset($childs['submenu_id']))
				{
					$other_menu.='<a class="menu__link" href="#" id="'.$childs['id'].'"><i class="fa '.$childs['icon'].'"></i>'.$childs['label'].'</a>';
				}
