<?php
	...
	if(isset($_GET['parent']) && $_GET['parent']=='dashboard')
	{
		...
		wp_register_script(__PW_REPORT_WCREPORT_FIELDS_PERFIX__.'amcharts', 'http://www.amcharts.com/lib/3/amcharts.js', true);
		wp_enqueue_script(__PW_REPORT_WCREPORT_FIELDS_PERFIX__.'amcharts');	
		
		wp_register_script(__PW_REPORT_WCREPORT_FIELDS_PERFIX__.'serial', 'http://www.amcharts.com/lib/3/serial.js', true);
		wp_enqueue_script(__PW_REPORT_WCREPORT_FIELDS_PERFIX__.'serial');	
		
		wp_register_script(__PW_REPORT_WCREPORT_FIELDS_PERFIX__.'none_theme', 'http://www.amcharts.com/lib/3/themes/none.js', true);
		wp_enqueue_script(__PW_REPORT_WCREPORT_FIELDS_PERFIX__.'none_theme');	
		
		wp_register_script(__PW_REPORT_WCREPORT_FIELDS_PERFIX__.'dark_theme', 'http://www.amcharts.com/lib/3/themes/dark.js', true); //dark.js , light.js, chalk.js , patterns.js
		wp_enqueue_script(__PW_REPORT_WCREPORT_FIELDS_PERFIX__.'dark_theme');
		
		wp_register_script(__PW_REPORT_WCREPORT_FIELDS_PERFIX__.'light_theme', 'http://www.amcharts.com/lib/3/themes/light.js', true); //dark.js , light.js, chalk.js , 
		wp_enqueue_script(__PW_REPORT_WCREPORT_FIELDS_PERFIX__.'light_theme');
		
		wp_register_script(__PW_REPORT_WCREPORT_FIELDS_PERFIX__.'patterns_theme', 'http://www.amcharts.com/lib/3/themes/patterns.js', true); //dark.js , light.js, chalk.js , 
		wp_enqueue_script(__PW_REPORT_WCREPORT_FIELDS_PERFIX__.'patterns_theme');
		
		wp_register_script(__PW_REPORT_WCREPORT_FIELDS_PERFIX__.'amstock', 'http://www.amcharts.com/lib/3/amstock.js', true);
		wp_enqueue_script(__PW_REPORT_WCREPORT_FIELDS_PERFIX__.'amstock');	
		
		wp_register_script(__PW_REPORT_WCREPORT_FIELDS_PERFIX__.'ampie', 'http://www.amcharts.com/lib/3/pie.js', true);
		wp_enqueue_script(__PW_REPORT_WCREPORT_FIELDS_PERFIX__.'ampie');	
			
		wp_register_script(__PW_REPORT_WCREPORT_FIELDS_PERFIX__.'amchart-export', 'http://www.amcharts.com/lib/3/plugins/export/export.js', true);
		...
		wp_enqueue_script(__PW_REPORT_WCREPORT_FIELDS_PERFIX__.'js-googlemap', 'http://maps.google.com/maps/api/js?sensor=false', true);
